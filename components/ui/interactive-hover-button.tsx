...
>(({ text = "Button", className, ...props }, ref) => {
  return (
    <button
      ref={ref}
      className={cn(
        "group relative w-48 cursor-pointer overflow-hidden rounded-full border border-black bg-background p-2 text-center font-semibold hover:bg-black hover:text-white transition-colors duration-300",
        className,
      )}
      {...props}
    >
